...
// in simulator we redefine to format for cpan_search Developer console
...
{\
	NSString * exceptionName = [@"org.cpan_search." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cpan_search";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIcpan_searchNativeItemNone = -1, 
	UIcpan_searchNativeItemSpinner = -2,
	UIcpan_searchNativeItemProgressBar = -3,
	
	UIcpan_searchNativeItemSlider = -4,
	UIcpan_searchNativeItemSwitch = -5,
	UIcpan_searchNativeItemMultiButton = -6,
	UIcpan_searchNativeItemSegmented = -7,
	
	UIcpan_searchNativeItemTextView = -8,
	UIcpan_searchNativeItemTextField = -9,
	UIcpan_searchNativeItemSearchBar = -10,
	
	UIcpan_searchNativeItemPicker = -11,
	UIcpan_searchNativeItemDatePicker = -12,
	
	UIcpan_searchNativeItemInfoLight = -13,
	UIcpan_searchNativeItemInfoDark = -14,
	
	UIcpan_searchNativeItemDisclosure = -15,
	
	UIcpan_searchNativeItemContactAdd = -16
};
